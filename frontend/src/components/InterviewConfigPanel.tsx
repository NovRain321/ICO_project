    ...
    >
      <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-amber-900 mb-1">检测到未完成的案件复盘</h3>
                  <p className="text-sm text-amber-700">
                    已完成 {unfinishedSession.currentQuestionIndex} / {unfinishedSession.totalQuestions} 项核查
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="mb-6">
            <label className="block text-sm font-semibold text-slate-600 mb-3">案件材料预览（前500字）</label>
            <textarea 
          ...
          <p className="text-sm text-slate-500 mb-6">
            问题分布：案情事实(20%) + 交通违法(20%) + 责任认定(20%) + 证据分析/法规适用/处置建议(40%)
          </p>
