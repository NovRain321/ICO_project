  ...
  return (
    ...
    >
      ...
      >
        {/* 渐变边框效果 */}
        <div
          className={`absolute inset-0 rounded-2xl p-[2px] bg-gradient-to-r from-amber-200 via-orange-200 to-amber-200 -z-10
          ${dragOver ? 'from-amber-400 via-orange-400 to-amber-400' : ''}`}
        >
              ...
              >
                <motion.div
                  className={`w-20 h-20 mx-auto rounded-2xl flex items-center justify-center transition-colors
                    ${dragOver ? 'bg-amber-100 text-amber-600' : 'bg-slate-100 text-slate-400'}`}
                ...
                <motion.button
                  className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-8 py-3.5 rounded-xl font-semibold shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 transition-all"
      ...
      <div className="mt-8 flex gap-4 justify-center">
        ...
        {selectedFile && (
          <motion.button
            ...
            disabled={uploading}
            className="px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-semibold shadow-lg shadow-amber-500/30 hover:shadow-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
