      ...
      <div className="bg-white rounded-2xl p-6 mb-4 shadow-sm">
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-semibold text-slate-700">
            核查项 {currentQuestion ? currentQuestion.questionIndex + 1 : 0} / {session.totalQuestions}
          </span>
        ...
        <div className="border-t border-slate-200 p-4 bg-slate-50">
          <div className="flex gap-3">
            <textarea
              ...
              placeholder="输入核查结论... (Ctrl/Cmd + Enter 提交)"
              className="flex-1 px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent resize-none"
              rows={3}
            ...
            <div className="flex flex-col gap-2">
              <motion.button
                ...
                className="px-6 py-3 bg-amber-500 text-white rounded-xl font-medium hover:bg-amber-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-sm font-semibold text-slate-700">复盘引导</span>
            {message.category && (
          ...
          <div className="bg-slate-700 rounded-2xl rounded-tl-none p-4 text-slate-100 leading-relaxed">
            {message.content}
          </div>
        </div>
      </motion.div>
  ...
  return (
    ...
    >
      <div className="flex-1 max-w-[80%]">
        <div className="bg-amber-500 text-white rounded-2xl rounded-tr-none p-4 leading-relaxed">
          {message.content}
        </div>
      </div>
