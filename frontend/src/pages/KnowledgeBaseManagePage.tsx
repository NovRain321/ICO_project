        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-4 pr-10 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white cursor-pointer"
            >
                      ...
                      {editingCategoryId === kb.id ? (
                        ...
                        >
                          <input
                            ...
                            className="w-24 px-2 py-1 text-sm border border-amber-300 rounded focus:outline-none focus:ring-2 focus:ring-amber-500"
                        ...
                        >
                          ...
                          <button
                            ...
                            className="p-1 text-slate-400 hover:text-amber-500 hover:bg-amber-50 rounded opacity-0 group-hover/category:opacity-100 transition-all"
                            title="编辑分类"
                          >
