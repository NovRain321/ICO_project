...
/**
 * 案件控制器
 * Case Controller for upload and analysis
 */
@Slf4j
@RestController
...
public class ResumeController {
     ...
     * 上传案件材料并获取研判结果
     *
     * @param file 案件材料文件（支持PDF、DOCX、DOC、TXT）
     * @return 案情研判结果，包含评分和建议
     */
    ...
    public Result<Map<String, String>> health() {
        return Result.success(Map.of(
            "status", "UP",
            "service", "AI Traffic Police Analysis Platform - Case Service"
        ));
    }
